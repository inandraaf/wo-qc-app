<x-app-layout>
    <x-slot name="topbar-title">Dasbor Super Admin</x-slot>
    <x-slot name="topbar-subtitle">Full Access Dashboard</x-slot>

    <div class="page-header">
        <div class="page-header-text">
            <h1>Dasbor Super Admin</h1>
            <p>Monitoring seluruh aktivitas dengan akses penuh</p>
        </div>
    ...
    <div style="display:flex; gap:0.75rem; flex-wrap:wrap; margin-bottom:1.5rem;">
        ...
        <a href="{{ route('quality-controls.index') }}" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (qcRateCtx) {
        const totalQc = {{ $totalQcGood + $totalQcBad }};
        new Chart(qcRateCtx, {
            type: 'doughnut',
            data: {
